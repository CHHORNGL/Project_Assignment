...
class Config:
    ...
    # Flask connects only to the owner's self-trained remote model and never
    # loads model weights or exposes the inference token to web/mobile clients.
    AI_PROVIDER = "own-ai"
    ...
    AI_LEGACY_FALLBACK_ENABLED = False
